# From Label Smoothing to Label Relaxation — original AAAI 2021 code

> **Note:** This directory contains the original code of the AAAI 2021 paper, kept frozen for
> reproducibility. For the maintained PyTorch package, see the [repository root](../README.md)
